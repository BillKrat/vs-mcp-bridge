...
The local prototype design is captured in `SolutionFolder/docs/adventures-auth-local-prototype-design.md`.
The first local prototype validation trace is captured in `SolutionFolder/docs/session-handoffs/2026-05-17-adventures-auth-local-prototype-validation.md`.
The BlogAI consumer boundary is captured in `SolutionFolder/docs/blogai-adventures-auth-consumer-design.md`.
The local API boundary design and initial skeleton are captured in `SolutionFolder/docs/adventures-auth-local-api-boundary-design.md`; the skeleton uses ASP.NET Core Minimal APIs with thin endpoint handlers.
The local API skeleton validation trace is captured in `SolutionFolder/docs/session-handoffs/2026-05-17-adventures-auth-local-api-validation.md`.
The preferred initial BlogAI UI framework is Blazor Web App, recorded in `SolutionFolder/docs/adr/0002-blogai-ui-framework.md`.
