...
- durable validation: `SolutionFolder/artifacts/logs/mcp-preview-document-update-trace-20260517.*`, `SolutionFolder/docs/diagrams/mcp-preview-document-update-trace-20260517.mmd`, and `SolutionFolder/docs/session-handoffs/2026-05-17-preview-document-update-validation.md`
...
Practical future improvements are planned in `SolutionFolder/docs/preview-diff-ergonomics-plan.md` and must preserve the preview-only, no-mutation boundary.
...
```json
{
  ...
  "operationId": "...",
  "previewOnly": true,
  "targetPath": "SolutionFolder/docs/example.md",
  "targetExists": true,
...
The mutation threshold in `SolutionFolder/docs/mcp-controlled-mutation-threshold.md` still governs any future apply/write tool.
