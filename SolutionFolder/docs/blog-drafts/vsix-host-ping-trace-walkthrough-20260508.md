...
- workflow: `SolutionFolder/docs/vsix-host-ping-trace-workflow.md`
- diagram: `SolutionFolder/docs/diagrams/vsix-host-ping-trace-20260508.mmd`
- log transcript: `SolutionFolder/artifacts/logs/vsix-host-ping-trace-20260508.log`
- metadata: `SolutionFolder/artifacts/logs/vsix-host-ping-trace-20260508.metadata.json`
