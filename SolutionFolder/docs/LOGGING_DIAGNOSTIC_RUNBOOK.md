...
- use `SolutionFolder/docs/app-host-ping-trace-workflow.md` when you need a durable AI-runnable procedure for launching the App host, exercising `ping`, capturing correlated logs, generating a Mermaid sequence diagram, and comparing the observed flow against code
- store dated artifacts under `SolutionFolder/artifacts/logs/`, `SolutionFolder/docs/diagrams/`, and `SolutionFolder/docs/blog-drafts/` rather than overwriting prior runs
...
- use `SolutionFolder/docs/vsix-host-ping-trace-workflow.md` when you need a durable AI-runnable procedure for launching the Experimental Instance, exercising `ping`, capturing correlated tool-window evidence, generating a Mermaid sequence diagram, and comparing the observed flow against code
- store dated artifacts under `SolutionFolder/artifacts/logs/`, `SolutionFolder/docs/diagrams/`, and `SolutionFolder/docs/blog-drafts/` rather than overwriting prior runs
...
- use `SolutionFolder/docs/vsix-host-selected-text-trace-workflow.md` when you need a durable AI-runnable procedure for validating the prompt-box `what is the selected text` route against a real editor selection
...
Use `SolutionFolder/docs/tool-execution-trace-workflow.md` when you need a durable AI-runnable procedure for validating the shared bridge tool catalog/executor path.
...
- `SolutionFolder/artifacts/logs/tool-security-trace-20260509.metadata.json`
...
- `SolutionFolder/artifacts/logs/vsix-activation-diagnostic-trace-20260516.metadata.json`
...
For the read-only inventory diagnostic, direct MCP stdio validation is captured in `SolutionFolder/artifacts/logs/mcp-tool-inventory-live-validation-20260516.*` and `SolutionFolder/docs/diagrams/mcp-tool-inventory-live-validation-20260516.mmd`.
