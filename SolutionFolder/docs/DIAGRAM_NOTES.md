...
For full-system behavior, request flow, approval flow, and component relationships, use `SolutionFolder/docs/ARCHITECTURE.md` as the source of truth.
...
This sequence is a diagram-oriented view of the runtime behavior already defined in `SolutionFolder/docs/ARCHITECTURE.md`.
...
Mermaid is a text-based diagram language. Use it here as a lightweight way to express the architecture already described in `SolutionFolder/docs/ARCHITECTURE.md`.
