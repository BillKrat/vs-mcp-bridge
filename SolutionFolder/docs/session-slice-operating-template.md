...
- BlogAI deploy retry: read `SolutionFolder/docs/session-handoffs/2026-05-17-blogai-webdeploy-validation.md` and `SolutionFolder/docs/session-handoffs/2026-05-17-blogai-deployed-guardrail-validation.md`.
- Preview-only MCP mutation work: read `SolutionFolder/docs/mcp-controlled-mutation-threshold.md`, `SolutionFolder/docs/preview-only-document-update-tool-design.md`, and `SolutionFolder/docs/session-handoffs/2026-05-17-preview-document-update-validation.md`.
- Gated ChatGPT to Codex work: read `SolutionFolder/docs/chatgpt-codex-gated-handoff-workflow.md` and `SolutionFolder/docs/session-handoffs/2026-05-17-gated-handoff-tool-readiness-review.md`.
...
- handoff: `SolutionFolder/docs/session-handoffs/<date>-<topic>.md`
- trace log: `SolutionFolder/artifacts/logs/<run>.log`
- metadata: `SolutionFolder/artifacts/logs/<run>.metadata.json`
- sequence diagram: `SolutionFolder/docs/diagrams/<run>.mmd`
- design note: `SolutionFolder/docs/<topic>.md`
