...
For future security slices, start from `SolutionFolder/docs/ARCHITECTURE.md`, this handoff, and the durable trace workflow in `SolutionFolder/docs/tool-execution-trace-workflow.md`.
