...
- trace log: `SolutionFolder/artifacts/logs/gated-handoff-preview-tool-trace-20260517.log`
- metadata: `SolutionFolder/artifacts/logs/gated-handoff-preview-tool-trace-20260517.metadata.json`
- sequence diagram: `SolutionFolder/docs/diagrams/gated-handoff-preview-tool-trace-20260517.mmd`
- readiness review: `SolutionFolder/docs/session-handoffs/2026-05-17-gated-handoff-preview-tool-implementation-readiness.md`
- candidate design: `SolutionFolder/docs/first-gated-handoff-preview-tool-candidate.md`
- workflow design: `SolutionFolder/docs/chatgpt-codex-gated-handoff-workflow.md`
...
- `SolutionFolder/docs/session-handoffs/2026-05-17-gated-handoff-preview-tool-implementation-readiness.md`
