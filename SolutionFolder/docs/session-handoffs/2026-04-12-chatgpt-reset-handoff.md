...
- the HTML/browser-rendered preview remains backlog only in `SolutionFolder/docs/backlog/html-rendered-proposal-preview.md`
...
- use this handoff, `README.md`, and `SolutionFolder/docs/VS_MCP_BRIDGE_TECHNICAL_ANALYSIS.md` as the initial grounding set
...
- `SolutionFolder/docs/backlog/html-rendered-proposal-preview.md`
- `SolutionFolder/docs/session-handoffs/2026-04-12-chatgpt-reset-handoff.md`
