...
- Log artifact: `SolutionFolder/artifacts/logs/vsix-host-selected-text-trace-20260509.log`
- Metadata artifact: `SolutionFolder/artifacts/logs/vsix-host-selected-text-trace-20260509.metadata.json`
- Mermaid sequence: `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`
