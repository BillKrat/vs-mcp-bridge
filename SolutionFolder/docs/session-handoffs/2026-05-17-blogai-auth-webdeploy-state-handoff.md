...
- `SolutionFolder/docs/session-handoffs/2026-05-17-auth-api-admin-boundary-decision.md`
- `SolutionFolder/docs/session-handoffs/2026-05-17-adventures-auth-local-api-validation.md`
