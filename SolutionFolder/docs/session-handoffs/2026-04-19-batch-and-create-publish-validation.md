...
- canonical create-path fixture post under `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-publish-create-trial/`
...
- `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-publish-create-trial/post.json`
- `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-publish-create-trial/content.html`
...
- `SolutionFolder/scripts/blog-publishing/Publish-BlogPosts.ps1`
...
- `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-publish-create-trial/**`
- this handoff file
