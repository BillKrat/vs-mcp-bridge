...
Observed evidence is summarized in `SolutionFolder/artifacts/logs/blogai-stale-chrome-search-pressure-test-20260516.log`.
...
- `rg -n "feature/approval-apply-ui-slice" SolutionFolder/docs/blogs/posts`
- `rg -n "feature/approval-apply-ui-slice" SolutionFolder/docs/blogs SolutionFolder/docs/session-handoffs scripts -g "*.md" -g "*.ps1"`
- `rg -n "feature/approval-apply-ui-slice" SolutionFolder/docs/blogs/source-of-truth/widget-settings SolutionFolder/docs/blogs/source-of-truth/db-export-20260516 SolutionFolder/docs/blogs/source-of-truth/publish-review-updates -g "*.txt" -g "*.json" -g "*.html" -g "*.md"`
...
- `SolutionFolder/docs/blogs/stale-shared-feature-branch-link-inspection-20260516.md`
- `SolutionFolder/docs/blogs/blogengine-cache-clear-failure-inspection-20260516.md`
- `SolutionFolder/docs/blogs/final-rendered-route-verification-after-cache-clear-20260516.md`
- `SolutionFolder/docs/blogs/final-rendered-route-verification-20260516.md`
...
- `SolutionFolder/docs/blogs/source-of-truth/publish-review-updates/20260516/`
...
- `SolutionFolder/docs/blogs/posts` had no matches for `feature/approval-apply-ui-slice`.
...
- Preserved DB export and before-update publish-review artifacts still contain old feature-branch `SolutionFolder/docs/ARCHITECTURE.md` links for several rows.
...
4. Re-run `SolutionFolder/scripts/blog-publishing/Test-BlogRenderedRoutes.ps1` across the 14 routes.
...
- `SolutionFolder/scripts/validate-mcp.ps1` still validates a different path and is documented as having helper-build hang risk in earlier runs.
...
See `SolutionFolder/docs/session-handoffs/2026-05-16-mcp-regex-search-validation.md` and `SolutionFolder/artifacts/logs/mcp-regex-search-trace-20260516.log`.

A follow-up BlogAI workload then reran this stale chrome search through `bridge_regex_text_search`.
It confirmed zero matches in canonical `SolutionFolder/docs/blogs/posts`, selected local BlogAI source files, and current after-update widget row `26512` settings, with matches limited to stale diagnostic reports, preserved before-update widget evidence, historical DB export sample rows, and this handoff.
See `SolutionFolder/docs/session-handoffs/2026-05-16-blogai-stale-chrome-mcp-regex-search.md` and `SolutionFolder/artifacts/logs/blogai-stale-chrome-mcp-regex-search-20260516.log`.
...
1. `AI_START.md`
2. this handoff
3. `SolutionFolder/artifacts/logs/blogai-stale-chrome-search-pressure-test-20260516.log`
4. `SolutionFolder/docs/blogs/blogengine-cache-clear-failure-inspection-20260516.md`
5. `SolutionFolder/docs/blogs/stale-shared-feature-branch-link-inspection-20260516.md`
