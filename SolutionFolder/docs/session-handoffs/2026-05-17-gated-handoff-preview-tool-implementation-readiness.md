...
- `SolutionFolder/docs/session-handoffs/2026-05-17-gated-handoff-tool-readiness-review.md`
- `SolutionFolder/docs/first-gated-handoff-preview-tool-candidate.md`
- `SolutionFolder/docs/future-contributor-operating-expectations.md`
