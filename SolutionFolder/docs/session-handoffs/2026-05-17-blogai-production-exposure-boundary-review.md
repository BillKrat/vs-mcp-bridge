...
- `SolutionFolder/docs/session-handoffs/2026-05-17-blogai-auth-api-client-next-step-decision.md`
...
Durable evidence is captured in `SolutionFolder/docs/session-handoffs/2026-05-17-blogai-deployed-guardrail-validation.md`. Local smoke validation passed, but `https://api.global-webnet.com` still served the previous build after a permitted WebDeploy attempt failed with `401 Unauthorized`.
