...
- `SolutionFolder/docs/blogai-auth-api-boundary-note.md`
- `SolutionFolder/docs/blogai-auth-trust-boundary-flow.md`
- `SolutionFolder/docs/session-handoffs/2026-05-17-platform-to-blogai-transition.md`
...
The implementation gate checklist is `SolutionFolder/docs/blogai-auth-implementation-gate.md`.
The minimal local prototype objective is clarified in `SolutionFolder/docs/blogai-minimal-auth-prototype-clarification.md`.
The local `AdventuresAuth` prototype design is `SolutionFolder/docs/adventures-auth-local-prototype-design.md`.
The BlogAI consumer boundary design is `SolutionFolder/docs/blogai-adventures-auth-consumer-design.md`.
