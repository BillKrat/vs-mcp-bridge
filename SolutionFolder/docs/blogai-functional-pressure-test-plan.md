...
- The first shell validation is captured in `SolutionFolder/docs/session-handoffs/2026-05-17-blogai-blazor-shell-validation.md`.
...
5. Preserve findings in durable handoffs.
   - Add or update focused handoffs under `SolutionFolder/docs/session-handoffs/` when a future session needs a clean resume point.
   - Link trace artifacts, diagrams, commands, and validation status.
   - Keep `SolutionFolder/docs/ARCHITECTURE.md` as the system-behavior source of truth when platform behavior actually changes.
