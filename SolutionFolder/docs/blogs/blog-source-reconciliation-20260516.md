...
- Inventory: `SolutionFolder/docs/blogs/blog-alignment-inventory-20260516.md`
- DB export manifest: `SolutionFolder/docs/blogs/source-of-truth/db-export-20260516/manifest.json`
- DB row folders: `SolutionFolder/docs/blogs/source-of-truth/db-export-20260516/<slug>/`
- Canonical post root: `SolutionFolder/docs/blogs/posts/`

## Canonical Posts Added

The following active DB-exported BlogAI candidate posts now have canonical repo folders under `SolutionFolder/docs/blogs/posts/`.
...
The active BlogAI candidate set from the inventory is now represented in `SolutionFolder/docs/blogs/posts/`.
...
Before this slice, `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-blog-series-part-4/` contained a repo trial draft whose `post.json` declared slug `vs-mcp-bridge-blog-series-part-4-repo-trial`.
...
| --- | --- | --- | --- |
| Live DB/exported Part 4 post | `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-blog-series-part-4/` | `vs-mcp-bridge-blog-series-part-4` | published metadata copied from DB export |
| Repo publishing trial draft | `SolutionFolder/docs/blogs/posts/vs-mcp-bridge-blog-series-part-4-repo-trial/` | `vs-mcp-bridge-blog-series-part-4-repo-trial` | draft trial artifact |
...
The exact raw plugin settings are preserved under `SolutionFolder/docs/blogs/source-of-truth/gwn-wiki-extension-export-20260516/`.
...
- `SolutionFolder/docs/blogs/posts/`
