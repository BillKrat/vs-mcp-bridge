...
| `vs-mcp-bridge-blog-series-part-2` | None | `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
| `vs-mcp-bridge-blog-series-part-3` | None | `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
| `vs-mcp-bridge-blog-series-part-4` | None | `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-security-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/mef-discovery-trace-20260516.mmd` |
| `vs-mcp-bridge-blog-series-part-5` | `[Page:Playbook]` | `SolutionFolder/docs/diagrams/mef-discovery-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-security-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd` |
| `vs-mcp-bridge-blog-series-part-6` | `[Page:Evidence]` | `SolutionFolder/docs/diagrams/tool-security-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/mef-discovery-trace-20260516.mmd` |
| `vs-mcp-bridge-blog-series-part-7` | None | `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-security-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/mef-discovery-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd` |
| `how-stdio-works-in-vs-mcp-bridge` | `[Page:Stdio]` | `SolutionFolder/docs/blogs/diagrams/vs-mcp-bridge-bootstrap-sequence.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
| `understanding-a-named-pipe-listener` | `[Page:NamedPipeListener]` | `SolutionFolder/docs/blogs/diagrams/vs-mcp-bridge-bootstrap-sequence.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd` |
| `understanding-local-mcp-server-over-stdio-and-local-only-communication-over-a-named-pipe` | None | `SolutionFolder/docs/blogs/diagrams/vs-mcp-bridge-bootstrap-sequence.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-security-trace-20260509.mmd` |
| `wpf-vsix-threading-understanding-ui-switching-async-behavior-and-pipe-safety` | None | `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd` |
| `why-vsix-project-should-target-net-framework-4-7-2` | None | `SolutionFolder/docs/diagrams/vsix-host-ping-trace-20260508.mmd`, `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
| `inference-driven-software-design-with-copilot-pros-and-cons` | `[Page:InferenceDriven]`, `[Display:ChatSessionsModelsAndAgents]` | `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
| `understanding-ai-chat-sessions-models-and-agents` | `[Page:ChatSessionsModelsAndAgents]`, `[Display:inference-driven\|InferenceDriven]` | `SolutionFolder/docs/diagrams/vsix-host-selected-text-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-regex-search-trace-20260509.mmd`, `SolutionFolder/docs/diagrams/tool-approval-trace-20260516.mmd`, `SolutionFolder/docs/diagrams/vsix-activation-diagnostic-trace-20260516.mmd` |
...
Canonical post content under `SolutionFolder/docs/blogs/posts/` was checked for:
...
- Confirm the target canonical folder under `SolutionFolder/docs/blogs/posts/<slug>/`.
