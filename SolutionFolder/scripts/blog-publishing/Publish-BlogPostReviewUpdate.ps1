...
$reportLines.Add('')
$reportLines.Add('This report records a single-post BlogEngine body update from canonical repo source.')
...
$reportLines.Add('')
$reportLines.Add('Taxonomy was preserved from the live DB row for this body publish. Canonical `post.json` categories and tags were not applied in this slice because the goal was the smallest safe mutation for a single-post review update.')
$reportLines.Add('')
...
$reportLines.Add('')
$reportLines.Add('Call the BlogAI post-cache reload endpoint if needed, verify the rendered route contains unique canonical content markers, then continue with the next single-post review update only after this row is confirmed.')
