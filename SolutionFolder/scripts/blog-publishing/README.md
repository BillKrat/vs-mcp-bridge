...
- [Publish-BlogPostDraft.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Publish-BlogPostDraft.ps1)
- [Publish-BlogPostReviewUpdate.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Publish-BlogPostReviewUpdate.ps1)
- [Export-BlogPostsFromDatabase.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Export-BlogPostsFromDatabase.ps1)
- [Export-GwnWikiExtensionSettings.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Export-GwnWikiExtensionSettings.ps1)
- [Export-DataStoreSettingRow.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Export-DataStoreSettingRow.ps1)
- [Compare-BlogPostBeforePublish.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Compare-BlogPostBeforePublish.ps1)
- [Compare-ReadyBlogPostsBeforePublish.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Compare-ReadyBlogPostsBeforePublish.ps1)
- [Compare-BlockedBlogRowsBeforePublish.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Compare-BlockedBlogRowsBeforePublish.ps1)
- [Test-BlogRenderedRoutes.ps1](Y:/vs-mcp-bridge/SolutionFolder/scripts/blog-publishing/Test-BlogRenderedRoutes.ps1)
...
By default the script writes a dated markdown report under `SolutionFolder/docs/blogs/`.
It performs a parameterized `SELECT` only and does not publish, reload, update, or delete database records.

`Compare-ReadyBlogPostsBeforePublish.ps1` runs the same read-only compare for every slug listed in `SolutionFolder/docs/blogs/blog-publishing-review-plan-20260516.md` as ready for publishing review.
...
By default the script writes `SolutionFolder/docs/blogs/prepublish-compare-ready-posts-20260516.md`.
...
By default the script writes `SolutionFolder/docs/blogs/prepublish-blocked-row-diff-20260516.md`.
It performs parameterized `SELECT` calls only and does not publish, reload, update, or delete database records.
...
1. Update the canonical post under `SolutionFolder/docs/blogs/posts/<slug>/`.
