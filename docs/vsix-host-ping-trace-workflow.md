...
- sequence diagram: [`docs/diagrams/vsix-host-ping-trace-20260508.mmd`](diagrams/vsix-host-ping-trace-20260508.mmd)
- observed log transcript: [`artifacts/logs/vsix-host-ping-trace-20260508.log`](../artifacts/logs/vsix-host-ping-trace-20260508.log)
- run metadata: [`artifacts/logs/vsix-host-ping-trace-20260508.metadata.json`](../artifacts/logs/vsix-host-ping-trace-20260508.metadata.json)
- developer-facing summary: [`docs/blog-drafts/vsix-host-ping-trace-walkthrough-20260508.md`](blog-drafts/vsix-host-ping-trace-walkthrough-20260508.md)
