...
- `AI_START.md`
- `docs/session-handoffs/2026-05-17-blogai-local-auth-api-client-readiness-review.md`
...
- `artifacts/logs/blogai-local-auth-api-client-boundary-trace-20260517.log`
- `artifacts/logs/blogai-local-auth-api-client-boundary-trace-20260517.metadata.json`
- `docs/diagrams/blogai-local-auth-api-client-boundary-trace-20260517.mmd`
