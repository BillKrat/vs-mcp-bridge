...
1. `AI_START.md`
2. `docs/session-handoffs/2026-05-16-platform-self-description-handoff.md`
3. this handoff
4. `docs/tool-package-boundary-plan.md`
5. `docs/blogs/README.md` when moving from direction into concrete blog workflows
