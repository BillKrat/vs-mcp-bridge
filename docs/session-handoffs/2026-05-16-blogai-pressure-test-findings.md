...
- `docs/blogai-functional-pressure-test-plan.md`
- `docs/blogai-first-pressure-test-session.md`
- `docs/session-handoffs/2026-05-16-blogai-platform-direction.md`
- MCP inventory evidence:
  ...
  - `docs/session-handoffs/2026-05-16-mcp-tool-inventory-validation.md`
  - `docs/session-handoffs/2026-05-16-tool-inventory-validation.md`
- BlogAI/blog source-of-truth and publishing artifacts:
  ...
  - targeted searches across `docs/blogs/`, `docs/session-handoffs/`, and `scripts/blog-publishing/`
...
- BlogAI repo-backed artifacts are discoverable and structured:
  - canonical posts live under `docs/blogs/posts/<slug>/`
  - preserved DB exports live under `docs/blogs/source-of-truth/db-export-20260516/`
  - widget and plugin settings exports are preserved under `docs/blogs/source-of-truth/`
...
- The prior `scripts/validate-mcp.ps1` helper has documented hang risk, so direct MCP validation is possible but not frictionless as a routine first step.
...
1. `AI_START.md`
2. `docs/blogai-functional-pressure-test-plan.md`
3. `docs/blogai-first-pressure-test-session.md`
4. this handoff
5. `docs/session-handoffs/2026-05-16-mcp-tool-inventory-live-validation.md`
6. `docs/blogs/blogengine-cache-clear-failure-inspection-20260516.md`
