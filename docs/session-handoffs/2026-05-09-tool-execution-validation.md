...
- workflow: `docs/tool-execution-trace-workflow.md`
- log transcript: `artifacts/logs/tool-regex-search-trace-20260509.log`
- metadata: `artifacts/logs/tool-regex-search-trace-20260509.metadata.json`
- diagram: `docs/diagrams/tool-regex-search-trace-20260509.mmd`
