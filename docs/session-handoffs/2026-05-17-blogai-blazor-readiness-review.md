...
| --- | --- | --- | --- |
| UI framework decision | Pass | `docs/adr/0002-blogai-ui-framework.md` records Blazor Web App as the preferred initial BlogAI UI framework and documents alternatives. | Keep React, Next.js, SvelteKit, Angular, MVC/Razor Pages, and static frontend options deferred unless real UI complexity justifies revisiting the ADR. |
