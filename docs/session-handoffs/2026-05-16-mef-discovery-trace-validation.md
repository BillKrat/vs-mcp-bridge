...
- observed transcript: `artifacts/logs/mef-discovery-trace-20260516.log`
- run metadata: `artifacts/logs/mef-discovery-trace-20260516.metadata.json`
- Mermaid reconstruction: `docs/diagrams/mef-discovery-trace-20260516.mmd`
- workflow update: `docs/tool-execution-trace-workflow.md`
