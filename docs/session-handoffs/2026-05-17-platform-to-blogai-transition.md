...
- `docs/mcp-controlled-mutation-threshold.md`
- `docs/preview-only-document-update-tool-design.md`
- `docs/preview-diff-ergonomics-plan.md`
...
- `docs/session-handoffs/2026-05-16-blogai-pressure-test-findings.md`
- `docs/session-handoffs/2026-05-16-blogai-stale-chrome-mcp-regex-search.md`
...
Any future MCP apply/write tool requires a separate approval-required design and implementation slice under `docs/mcp-controlled-mutation-threshold.md`.

## Recommended Next BlogAI Work

Start actual BlogAI operational development from `docs/blogai-functional-pressure-test-plan.md`.
...
- preserve durable findings under `docs/session-handoffs/` or targeted BlogAI docs rather than chat-only notes
...
1. `AI_START.md`
2. this handoff
3. `docs/blogai-functional-pressure-test-plan.md`
4. `docs/blogai-first-pressure-test-session.md`
5. `docs/blogs/README.md`
6. the newest relevant BlogAI handoff or pressure-test evidence listed above

Suggested next prompt:

`Resume from docs/session-handoffs/2026-05-17-platform-to-blogai-transition.md and start a docs-only BlogAI auth/API boundary architecture pass. Do not implement auth or runtime code.`
