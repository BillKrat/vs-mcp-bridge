...
The workflow was analysis/docs/artifacts only. It did not implement BlogAI features, auth, deployment changes, file crawling, mutation, or MCP transport changes.
...
| 7 | `canonical-posts` | Canonical `docs/blogs/posts` aggregate | 32 |
...
- The stale branch marker still did not match canonical `docs/blogs/posts`.
