...
Use `docs/tool-execution-trace-workflow.md` for repeatable trace capture and `docs/diagrams/tool-approval-trace-20260516.mmd` for the reconstructed sequence.
