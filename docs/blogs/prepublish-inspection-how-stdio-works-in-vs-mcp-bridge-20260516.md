...
- Fresh compare report: `docs/blogs/prepublish-compare-how-stdio-works-in-vs-mcp-bridge-20260516.md`
- Prior blocked-row report: `docs/blogs/prepublish-blocked-row-diff-20260516.md`
- Preserved export baseline: `docs/blogs/source-of-truth/db-export-20260516/how-stdio-works-in-vs-mcp-bridge/`
- Fresh current live DB export: `docs/blogs/source-of-truth/prepublish-inspections/20260516/how-stdio-works-in-vs-mcp-bridge-20260516-194637/current-live-db/`
- Canonical repo source: `docs/blogs/posts/how-stdio-works-in-vs-mcp-bridge/`
