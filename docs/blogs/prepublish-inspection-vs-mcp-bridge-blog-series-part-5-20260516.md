...
- Fresh compare report: `docs/blogs/prepublish-compare-vs-mcp-bridge-blog-series-part-5-20260516.md`
- Prior blocked-row report: `docs/blogs/prepublish-blocked-row-diff-20260516.md`
- Preserved export baseline: `docs/blogs/source-of-truth/db-export-20260516/vs-mcp-bridge-blog-series-part-5/`
- Fresh current live DB export: `docs/blogs/source-of-truth/prepublish-inspections/20260516/vs-mcp-bridge-blog-series-part-5-20260516-192412/current-live-db/`
- Canonical repo source: `docs/blogs/posts/vs-mcp-bridge-blog-series-part-5/`
