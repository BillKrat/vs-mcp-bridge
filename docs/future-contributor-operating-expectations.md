...
- `AI_START.md`
- `AGENTS.md`
- `docs/ARCHITECTURE.md` when architecture or runtime behavior may be touched
- the newest relevant handoff under `docs/session-handoffs/`
- targeted design or validation docs for the active area

For short sessions, use `docs/session-slice-operating-template.md`.
