...
The local API boundary design is captured in `docs/adventures-auth-local-api-boundary-design.md`, including the preference for ASP.NET Core Minimal APIs with thin endpoint handlers.
