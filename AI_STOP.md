...
- end or pause a session with `AI_STOP.md`
...
4. If the next session would benefit from a clean resume point, create or update a handoff in `docs/session-handoffs/`.
...
Create or update a file under `docs/session-handoffs/` when:
