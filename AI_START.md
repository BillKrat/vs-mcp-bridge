...
For the implemented local/dev-only BlogAI-side `AdventuresAuth` consumer adapter, inspect `VsMcpBridge.Shared/BlogAI/Auth` and `VsMcpBridge.Shared.Tests/BlogAiAuthConsumerTests.cs`.
